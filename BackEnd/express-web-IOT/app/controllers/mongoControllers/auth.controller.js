...
const AdminModel = require('../../models/mongoModels/Admin');
const { JWT_SECRET } = require('../../middleware/auth');

/**
 * Login para admin de MongoDB
 */
const loginAdmin = async (req, res) => {
    ...
    try {
        ...
        const admin = await AdminModel.findOne({ usuario_admin });
        if (!admin) {
...
const verifyToken = async (req, res) => {
    try {
        ...
        const admin = await AdminModel.findOne({ admin_id: req.user.admin_id });
